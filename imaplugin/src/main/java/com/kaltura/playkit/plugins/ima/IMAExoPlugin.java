...
public class IMAExoPlugin extends PKPlugin implements AdsProvider, com.google.ads.interactivemedia.v3.api.AdEvent.AdEventListener, AdErrorEvent.AdErrorListener, com.kaltura.playkit.plugins.ima.ExoPlayerWithAdPlayback.OnAdBufferListener {
    ...
    private com.kaltura.playkit.plugins.ima.ExoPlayerWithAdPlayback videoPlayerWithAdPlayback;
    ...
    public static final Factory factory = new Factory() {
        ...
        public PKPlugin newInstance() {
            return new com.kaltura.playkit.plugins.ima.IMAExoPlugin();
        }
    ...
    private AdsLoader.AdsLoadedListener getAdsLoadedListener() {
        ...
        adsLoadedListener = new AdsLoader.AdsLoadedListener() {
            ...
            public void onAdsManagerLoaded(AdsManagerLoadedEvent adsManagerLoadedEvent) {
                ...
                adsManager.addAdErrorListener(com.kaltura.playkit.plugins.ima.IMAExoPlugin.this);
                adsManager.addAdEventListener(com.kaltura.playkit.plugins.ima.IMAExoPlugin.this);
                sendCuePointsUpdateEvent();
